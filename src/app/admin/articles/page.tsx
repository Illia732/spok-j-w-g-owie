// src/app/admin/articles/page.tsx - KOMPLETNY KOD
'use client'
...
// KOMPONENT MODALU PROFILU UŻYTKOWNIKA - UPROSZCZONY
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      ...
                      <span className="font-medium text-sm">
                        {[user.firstName, user.lastName].filter(Boolean).join(' ') || 'Brak'}
                      </span>
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          ...
          {activeTab === 'articles' ? (
            ...
            <UsersTab 
              ...
              allUsers={allUsers}
              onViewProfile={(user: UserProfile) => {
...
function UsersTab({
  ...
  currentUser, onTestBlock, allUsers, onViewProfile
}: any) {
  return (
...
// KOMPONENT WIERSZA UŻYTKOWNIKA - POPRAWIONY Z KLIKALNYM PROFIL
function UserRow({ user, onBlock, onUnblock, onChangeRole, currentUser, onViewProfile }: any) {
  return (
    <div 
      className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200 hover:bg-white transition-colors cursor-pointer group"
